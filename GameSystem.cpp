...
bool BattleManager::startBattle(Player& player, bool debug, int& endingType) {
    ...
    if (enemyType == 1) { eName = "スライム"; eHp = 20; eAtk = 5; eExp = 5; eLv = 1; eMin = 50; eMax = 70; }
    else if (enemyType == 2) { eName = "ゴーレム"; eHp = 100; eAtk = 20; eExp = 20; eLv = 5; eMin = 150; eMax = 200; }
    else { eName = "ドラゴン"; eHp = 150; eAtk = 30; eExp = 30; eLv = 10; eMin = 400; eMax = 500; }
